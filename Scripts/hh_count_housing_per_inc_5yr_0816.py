...
hous_per = pd.read_csv('county_rent_vs_mort_and_inc_5yr.csv')
...
yrs = list(range(2008, 2017)) * 2
yrs.sort()
master_df['Year'] = yrs
master_df.to_csv('hh_count_housing_per_inc_5yr_0816.csv', index=False)
"""hirs = []
...
hh_count_df = pd.DataFrame({'Year':list(range(2008, 2017))*9, 'HIR':hirs, 'HH_Count':types})

hh_count_df.to_csv('hh_count_housing_per_inc_0816.csv', index=False)"""