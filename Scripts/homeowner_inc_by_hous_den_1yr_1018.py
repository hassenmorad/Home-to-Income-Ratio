# Homeowner monthly income by housing density
import pandas as pd
import numpy as np
import array
...
for year in range(2010, 2019):
    ...
    for fips_group in fips_groups:
        ...
        for fips in fips_group:
            med_mort = yr_df.Med_Mort_Inc[yr_df.FIPS == fips].iloc[0]
...
df.to_csv('homeowner_inc_by_hous_den_1yr_1018.csv', index=False)