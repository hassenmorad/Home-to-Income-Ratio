...
pop_den_df = pd.DataFrame({'Year':list(range(2008, 2017))*6, 'Mort_Share_Inc':mort_share, 'Home_Units':types})

pop_den_df.to_csv('mort_share_inc_by_hous_den_5yr_0816.csv', index=False)