# Calculating regional median HIRs (from IRS, Zillow, & Census data)
# IRS household counts (column N1): https://www.irs.gov/statistics/soi-tax-stats-individual-income-tax-statistics-zip-code-data-soi
import pandas as pd
import numpy as np
import array
