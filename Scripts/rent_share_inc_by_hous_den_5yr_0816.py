...
pop_den_df = pd.DataFrame({'Year':list(range(2008, 2017))*6, 'Rent_Share_Inc':rent_share, 'Home_Units':types})

pop_den_df.to_csv('rent_share_inc_by_hous_den_5yr_0816.csv', index=False)